...
le retrait d'Automation Rules et la destination fixe GitHub + Development. La
condition peut aussi porter exactement `payload.workItemRef`; elle devient alors
la portée `issue` conservée dans Development. Toute
